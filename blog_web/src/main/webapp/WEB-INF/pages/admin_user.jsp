    ...
    <div class="center">
        <ul class="pagination">
            <c:if test="${pageInfo.pageNum==1}">
                <li><a style="pointer-events: none;cursor:default;" href="/admin/userPage/1">首页</a></li>
            </c:if>
            <c:if test="${pageInfo.pageNum!=1}">
                <li><a href="/admin/userPage/1">首页</a></li>
            </c:if>
            <c:if test="${pageInfo.pageNum==1}">
                <li><a style="pointer-events: none;cursor:default;" href="/admin/userPage/${pageInfo.prePage}">前一页</a>
                </li>
            </c:if>
            <c:if test="${pageInfo.pageNum!=1}">
                <li><a href="/admin/userPage/${pageInfo.prePage}">前一页</a></li>
            </c:if>
            <li><a href="#">当前在${pageInfo.pageNum}页</a></li>
            <li><a href="#">共${pageInfo.pages}页</a></li>
            <c:if test="${pageInfo.pageNum==pageInfo.pages}">
                <li><a style="pointer-events:none;cursor:default;" href="/admin/userPage/${pageInfo.nextPage}">下一页</a>
                </li>
            </c:if>
            <c:if test="${pageInfo.pageNum!=pageInfo.pages}">
